...
for agenku in range(10000):
	...
	c='OPPO PBBT30 Build/OPM1.171019.026) '
	...
	k='Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/396.0.0.14.82;]'
	...
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='OPPO F1s Build/LMY47I)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.134'
	g=random.randrange(1, 9)
	h=random.randrange(1, 4)
	i=random.randrange(1, 4)
	j=random.randrange(1, 4)
	k='Mobile Safari/537.36 OppoBrowser/15.5.0.9'
